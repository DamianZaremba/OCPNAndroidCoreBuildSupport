...
macro(_populate_Core_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::Core PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Core_${ANDROID_ABI}.so"
...
if (NOT TARGET Qt5::Core)
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;hijricalendar;inotify;mimetype-database;poll_ppoll;sha3-fast)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;getentropy;glib;glibc;gnu-libiconv;icu;posix-libiconv;iconv;journald;linkat;lttng;system-pcre2;poll_poll;poll_pollts;poll_select;renameat2;slog2;statx;syslog;system-doubleconversion)
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core_${ANDROID_ABI}.so" "" FALSE)
