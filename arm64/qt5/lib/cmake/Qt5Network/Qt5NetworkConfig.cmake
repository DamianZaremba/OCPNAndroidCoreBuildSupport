...
macro(_populate_Network_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::Network PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Network_${ANDROID_ABI}.so"
...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network
                 ...
                 securetransport;schannel;dtls;gssapi;opensslv11;ocsp;sctp;ssl;sspi)
    set_property(TARGET Qt5::Network
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network_${ANDROID_ABI}.so" "" FALSE)
