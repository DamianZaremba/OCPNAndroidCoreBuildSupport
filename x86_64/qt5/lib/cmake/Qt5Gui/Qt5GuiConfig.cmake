...
macro(_populate_Gui_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::Gui PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Gui_${ANDROID_ABI}.so"
...
if (NOT TARGET Qt5::Gui)
    ...
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_DISABLED_FEATURES angle;combined-angle-lib;dynamicgl;opengles3;opengles31;opengles32;openvg;system-textmarkdownreader)
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 angle;combined-angle-lib;dynamicgl;opengles3;opengles31;opengles32;openvg;system-textmarkdownreader)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 egl;evdev;freetype;gif;harfbuzz;ico;imageio-text-loading;jpeg;multiprocess;png;raster-64bit;tuiotouch;vkgen)
    set_property(TARGET Qt5::Gui
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui_${ANDROID_ABI}.so" "" FALSE)
